    ...
    public static function save( $id = "" )
    {
        ...
        for( $i = 0; $i < $c; $i++ ) {
            ...
            if (!!$_POST[ 'downloads' ]) {
                ...
                $doc_name = $_POST[ 'upload_name' ][ 'actual' ][$i];
                $doc_title = $_POST[ 'upload_name' ][ 'user' ][$i];
            }
            ...
            if ( $uploads->save( array( 'title' => ( !!$doc_title ? $doc_title : $doc_name ), 'name' => $new_name, 'pages_id' => $id ) ) ) {
                $ids[] = $uploads->attributes[ 'id' ];
            }
        }
